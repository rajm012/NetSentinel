...
const PacketUploader = ({ onUpload, isLoading }) => {
  ...
  return (
    <div className="bg-white shadow rounded-lg p-6">
      <h2 className="text-xl font-bold text-gray-950 mb-4">Upload PCAP File</h2>
      ...
      >
        ...
        {selectedFile ? (
          ...
          <div className="mb-4">
            ...
            <p className="mt-1 text-gray-700">Drag and drop a .pcap file here, or click to select</p>
          </div>
        )}
        ...
        <div className="flex justify-center mt-4">
          <button
            type="button"
            onClick={handleClick}
            className="px-4 py-2 bg-gray-200 rounded-md text-gray-900 hover:bg-gray-300 mr-4"
          >
