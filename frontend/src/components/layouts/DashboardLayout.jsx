...
const DashboardLayout = () => {
  ...
  return (
    <div className="relative flex h-screen w-full bg-gradient-to-br from-gray-900 to-black text-white overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-blue-400/20 to-transparent blur-lg z-0" />
      <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-blue-400/20 to-transparent blur-lg z-0" />
            ...
            {showVisualization && (
              <div className="h-full flex flex-col items-center justify-center">
                ...
                <div className="max-w-4xl w-full">
                  ...
                  <div className="relative h-64 mb-8 bg-gray-900/80 rounded-xl border border-gray-800 overflow-hidden backdrop-blur-sm">
...
const StatCard = ({ title, value, trend, icon }) => {
  ...
  return (
    <div className="bg-gray-900/80 rounded-lg p-4 border border-gray-800 backdrop-blur-sm">
      <div className="flex justify-between items-start">
        <div>
          <p className="text-sm text-gray-400">{title}</p>
          <p className="text-2xl font-bold mt-1">{value}</p>
        </div>
        <div className={`p-2 rounded-lg bg-gray-800/50 ${trendColor}`}>
          {icon}
        </div>
      </div>
